...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .field .hint { font-size: 15px; color: #a1a1aa; margin-top: 10px; line-height: 1.7; }
  .field .hint strong { color: #fafafa; }
  .btn-start {
  ...
  .agno-logo-big {
    width: 72px; height: 72px; background: #f97316; border-radius: 18px;
    display: flex; align-items: center; justify-content: center;
    font-size: 36px; font-weight: 800; color: #09090b; margin-bottom: 12px;
    box-shadow: 0 0 40px #f9731644;
  }
  .agno-name-big { font-size: 28px; font-weight: 700; color: #fafafa; letter-spacing: -0.5px; }
  .agno-engine { font-size: 13px; color: #71717a; margin-top: 4px; }
  .chat-empty-sub { font-size: 14px; color: #71717a; margin-bottom: 32px; text-align: center; max-width: 500px; line-height: 1.6; }
  .starters { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 12px; width: 100%; max-width: 860px; }
  .starter-btn {
    background: #0f0f10; border: 1px solid #1f1f1f; border-radius: 12px;
    padding: 20px; cursor: pointer; text-align: left; transition: all 0.15s;
    font-family: inherit;
  }
  .starter-btn:hover { border-color: #f97316; background: #1a0f05; }
  .starter-letter {
    display: inline-block; background: #f9731622; border: 1px solid #f97316;
    color: #f97316; width: 28px; height: 28px; border-radius: 6px;
...
<div class="main">
  ...
  <div class="chat-area" id="chatArea">
    ...
    <div class="chat-empty" id="chatEmpty">
      <div class="agno-logo-center">
        <div class="agno-logo-big">F</div>
        <div class="agno-name-big">Agno</div>
        <div class="agno-engine">Claude Sonnet 4.6 &nbsp;·&nbsp; ifcopenshell &nbsp;·&nbsp; Coordenação AEC</div>
      </div>
      <div class="chat-empty-sub">Selecione uma verificação abaixo ou digite sua pergunta no campo de texto.</div>
      <div class="starters">
        <div class="starter-btn" onclick="enviarStarter('a')">
          ...
          <div class="starter-desc">Interferências 3D reais entre todas as disciplinas de instalações entre si e com a estrutura</div>
        </div>
        <div class="starter-btn" onclick="enviarStarter('b')">
          <div class="starter-letter">B</div>
          <div class="starter-title">Rota de Fuga</div>
          <div class="starter-desc">Distância entre portas de apartamento e porta corta-fogo da escada de incêndio (NBR 9077)</div>
        </div>
        <div class="starter-btn" onclick="enviarStarter('c')">
          ...
          <div class="starter-desc">Extintores por raio de cobertura (NBR 12693) e sprinklers por densidade de área do pavimento (NBR 10897)</div>
        </div>
